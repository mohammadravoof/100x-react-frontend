...
function Fieldset({text,input,icon,type, ...rest}) {
  return (
...
<div className="flex relative items-center self-stretch group border border-neutral-500 focus-within:border-twitter-blue-default rounded py-4 px-3 justify-between">
    <input className="peer text-xl/normal text-neutral-500 bg-transparent focus:outline-none focus-within:text-neutral-50 grow" type={type} placeholder={input} {...rest} />
