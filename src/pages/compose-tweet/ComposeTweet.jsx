...
function ComposeTweet() {
  ...
  <div className="flex py-3 px-4 justify-between items-center ">
    <button onClick={() => navigate("/100x-react-frontend/Homefeed")}><img src={signupx} /></button>
<button className="flex py-2 px-6 justify-center items-center gap-[10px] rounded-[30px] bg-twitter-blue-default hover:bg-twitter-blue-hover disabled:bg-twitter-blue-disabled shadow-[0_8px_16px_0_rgba(0,0,0,0.25)] backdrop-blur-[23.668209075927734px]" onClick={() => navigate("/100x-react-frontend/Homefeed")}><span className="text-center font-bold text-sm/normal text-neutral-50">Post</span></button>
  </div>
